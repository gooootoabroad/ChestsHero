...
//import { isEnabledVibrate } from "../runtime/setting";
...
const vxVideoAdUnitID = 'ad_tiny_2021006131664271_202603042202122593';

@ccclass('AliplayPlatform')
export class AliplayPlatform implements PlatformBase {
    // 分享时间纪录
